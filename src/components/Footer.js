...
const Footer = () => {
    return (
        <footer>
            <div>
                <StaticImage src='../images/brolga-red-01.png' className='footer-logo' height='50' />

                <ul>
                    <li><h3>Brolga Digital</h3></li>
                    <li>Melbourne, Australia</li>
                    <li>hello@brolgadigital.com.au</li>
                    <li><Link to='/contact' activeClassName="currentPage">Book a Consultation</Link></li>
                </ul>
            </div>
