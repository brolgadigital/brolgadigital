...
export default function joannebingham() {
    return (
        ...
        <Layout>
            ...
            <p>When Joanne approached us, she was using a default template from Wordpress, set up and managed by her husband. She wasn't a fan of the theme colours, and wanted something fresh and bright.</p>

            <div className='portfolio-image'>
                <StaticImage src='../../images/portfolio/joannebingham/Old Site.png' alt='Joanne Bingham Original Website' width='600' className='img' />
                <p className='image-caption'>The original site design for Joanne Bingham, with no branding</p>
            </div>
            ...
            <div className='portfolio-image'>
                ...
                <p className='image-caption'>Website redesign options we presented to Joanne.</p>
            </div>
            ...
            <div className='portfolio-image'>
                <StaticImage src='../../images/portfolio/joannebingham/Mockup 3.jpg' alt='Joanne Bingham Original Website' className='img' />
                <p className='image-caption'>The final design for Joanne's new, fresh-feeling website</p>
            </div>
            ...
            <div className='portfolio-image'>
                <StaticImage src='../../images/portfolio/joannebingham/Shop Update Proposal.jpg' alt='Joanne Bingham Original Website' width='600' className='img' />
                <p className='image-caption'>Shopfront landing page design, to encorporate her earrings into the online shop</p>
            </div>
