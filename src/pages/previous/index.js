...
export default function index() {
    return (
        <div>
            ...
            <p>
                Each of our projects is custom tailored to our clients needs. We
                build bespoke digital solutions to help branding stand out from
                the online noise.
            </p>
            ...
            <p>
                Starting from <b>$8000</b>, we create a completely unique
                solution tailored for your business; telling your story to the
                people who matter to you. Here's how it works.
            </p>
            ...
            <p className="last">
                We also promise not to build a something complicated and then
                abandon you when it gets hard. Check out our{" "}
                <Link to="../subscriptions">ongoing subscriptions</Link> for
                more information on how we can support you long term.
            </p>
