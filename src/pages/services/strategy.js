...
const strategy = () => {
  return (
    <>
      ...
      />
      <p>
        Have lots of product photos but not sure how to share them? Need an ad
        but can't figure out AdWords? Let us spend the time optimising your plan
        while you run your business.
      </p>
      <p>
        Even after you have a plan, we can continue to help you with captions,
        graphics, animations and a whole variety of other digital creations!
        Check out the <Link to="../subscriptions">ongoing subscriptions</Link>{" "}
